...
const PostCard = ({post}) => {
  // console.log("PostCard Using _id");
  // console.log("PostCard Using _id" + post);
  return (
    <div className={styles.container}>
      ...
      <div className={styles.bottom}>
        ...
        <p className={styles.desc}>Post ID : {post._id}</p>
        <Link className={styles.link} href={`/blogidapi/${post._id}`}>READ MORE</Link>
      </div>
    </div>
  )
}
